const LoginLeftSide = () => {
  return (
    <div className="hidden md:flex w-1/2 bg-purple-950 relative overflow-hidden border-r border-slate-200">
      <div className="absolute -top-30 -left-30 w-72 h-72 bg-purple-500/20 rounded-full blur-3xl"></div>
